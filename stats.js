...
function myClick(e) {
  if (e.target.value === "poisson") {
    ...
    forecast13.value = (
      (Number(actual11.value) + Number(actual12.value)) /
      2
    ).toFixed(2);
    forecast14.value = (
      (Number(actual12.value) + Number(actual13.value)) /
      2
    ).toFixed(2);
    ...
    if (Number(actual12.value) === 0) {
      forecast13.value = 0;
    } else {
      forecast13.value = (
        Number(forecast12.value) +
        (Number(actual12.value) * Number(alpha.value) -
          Number(forecast12.value) * Number(alpha.value))
      ).toFixed(2);
    }
    if (Number(actual13.value) === 0) {
      forecast14.value = 0;
    } else {
      forecast12.value = (
        Number(forecast13.value) +
        (Number(actual13.value) * Number(alpha.value) -
          Number(forecast13.value) * Number(alpha.value))
      ).toFixed(2);
    }
    ...
    forecast13.value = (
      (Number(actual11.value) * Number(weight1.value) +
        Number(actual12.value) * Number(weight2.value)) /
      Number(totalWeight.value)
    ).toFixed(2);
    forecast12.value = (
      (Number(actual12.value) * Number(weight1.value) +
        Number(actual13.value) * Number(weight2.value)) /
      Number(totalWeight.value)
    ).toFixed(2);
    ...
    forecast13.value = (
      (Number(actual10.value) * Number(weight1.value) +
        (Number(actual11.value) * Number(weight2.value) +
          Number(actual12.value) * Number(weight3.value))) /
      Number(totalWeight.value)
    ).toFixed(2);
    forecast14.value = (
      (Number(actual10.value) * Number(weight1.value) +
        (Number(actual12.value) * Number(weight2.value) +
          Number(actual13.value) * Number(weight3.value))) /
      Number(totalWeight.value)
    ).toFixed(2);
    ...
    if (num.value === "") {
      ...
      if (Number(actual13.value) === 0 || Number(forecast13.value) === 0) {
        error13.value = 0;
      } else if (Number(actual13.value) > Number(forecast13.value)) {
        error13.value = (
          Number(actual13.value) - Number(forecast13.value)
        ).toFixed(2);
      } else {
        error13.value = Number(
          forecast13.value - Number(actual13.value)
        ).toFixed(2);
      }
      if (Number(actual14.value) === 0 || Number(forecast14.value) === 0) {
        error14.value = 0;
      } else if (Number(actual14.value) > Number(forecast14.value)) {
        error14.value = (
          Number(actual14.value) - Number(forecast14.value)
        ).toFixed(2);
      } else {
        error14.value = Number(
          forecast14.value - Number(actual14.value)
        ).toFixed(2);
      }
      ...
      mad.value = (
        (Number(error1.value) +
          ...
          Number(error13.value) +
          Number(error14.value)) /
        Number(num.value)
      ).toFixed(2);
      ...
      mse.value = (
        (Math.pow(Number(error1.value), 2) +
          ...
          Math.pow(Number(error13.value), 2) +
          Math.pow(Number(error14.value), 2)) /
        Number(num.value)
      ).toFixed(2);
      let mape1 = 0;
      ...
      let mape13 = 0;
      if (Number(error12.value) === 0 || Number(actual12.value) === 0) {
        mape13 = 0;
      } else {
        mape13 = Number(error13.value) / Number(actual13.value);
      }
      let mape14 = 0;
      if (Number(error13.value) === 0 || Number(actual13.value) === 0) {
        mape14 = 0;
      } else {
        mape13 = Number(error14.value) / Number(actual14.value);
      }
